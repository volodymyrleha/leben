...
export default function CreateTaskTab(props) {
    ...
    return (
        <WorkspaceContainer>
            ...
            <DrawerEditor handleChange={data.handleChange} handleDescription={description.handleChange} create handleSend={sendSolution} />
        </WorkspaceContainer>
    );
};